...
//    cocos2d::experimental::ui::WebViewImpl::didFinishLoading(viewTag, url);
    return nullptr;
}
...
//    cocos2d::experimental::ui::WebViewImpl::didFailLoading(viewTag, url);
    return nullptr;
}
...
//    cocos2d::experimental::ui::WebViewImpl::onJsCallback(viewTag, url);
    return nullptr;
}