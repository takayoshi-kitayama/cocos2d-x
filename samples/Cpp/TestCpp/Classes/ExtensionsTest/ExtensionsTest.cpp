...
#if (CC_TARGET_PLATFORM != CC_PLATFORM_EMSCRIPTEN && CC_TARGET_PLATFORM != CC_PLATFORM_OHOS)
...
enum
{
    ...
    TEST_WEBSOCKET,
#endif
#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)|| (CC_TARGET_PLATFORM == CC_PLATFORM_OHOS) || (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID) || (CC_TARGET_PLATFORM == CC_PLATFORM_MAC) || (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32) || (CC_TARGET_PLATFORM == CC_PLATFORM_TIZEN) || (CC_TARGET_PLATFORM == CC_PLATFORM_WP8) || (CC_TARGET_PLATFORM == CC_PLATFORM_WINRT)
    TEST_EDITBOX,
#endif
	TEST_TABLEVIEW,
	TEST_COMPONENTS,
...
void ExtensionsMainLayer::menuCallback(CCObject* pSender)
{
    ...
    case TEST_COCOSBUILDER:
        ...
        break;
#if (CC_TARGET_PLATFORM != CC_PLATFORM_OHOS && CC_TARGET_PLATFORM != CC_PLATFORM_MARMALADE && CC_TARGET_PLATFORM != CC_PLATFORM_NACL && CC_TARGET_PLATFORM != CC_PLATFORM_EMSCRIPTEN && CC_TARGET_PLATFORM != CC_PLATFORM_WINRT)
    case TEST_HTTPCLIENT:
        ...
        break;
#endif
#if (CC_TARGET_PLATFORM != CC_PLATFORM_OHOS && CC_TARGET_PLATFORM == CC_PLATFORM_IOS) || (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID) || (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32)  || (CC_TARGET_PLATFORM == CC_PLATFORM_WP8)
        case TEST_WEBSOCKET:
        {
            runWebSocketTest();
        }
