...
#include "../../CCLogOhos.h"
#include "extensions/GUI/CCEditBox/CCEditBoxImplOhos.h"
...
napi_value InputNapi::editBoxOnFocusCB(napi_env env, napi_callback_info info) {
    ...
    cocos2d::extension::CCEditBoxImplOhos::onBeginCallBack(index);
    return nullptr;
}
...
napi_value InputNapi::editBoxOnChangeCB(napi_env env, napi_callback_info info) {
    ...
    cocos2d::extension::CCEditBoxImplOhos::onChangeCallBack(index, text);
    return nullptr;
}
...
napi_value InputNapi::editBoxOnEnterCB(napi_env env, napi_callback_info info) {
    ...
    cocos2d::extension::CCEditBoxImplOhos::onEnterCallBack(index, text);
    return nullptr;
}
...
napi_value InputNapi::textFieldTTFOnChangeCB(napi_env env, napi_callback_info info) {
      ...
      auto dispatcher = cocos2d::CCIMEDispatcher::sharedDispatcher();
